...
test('drafts and queues a telegram report from the current workspace', async ({ page }) => {
  ...
  await expect(page.getByTestId('telegram-report-preview')).toContainText('Project path: C:/Users/demo/demo-project')
  ...
  await expect(page.getByTestId('telegram-report-preview')).toContainText('C:/Users/demo/demo-project')
})
